    ...
    >
      ...
      <div class="flex justify-between items-center mt-10 font-khmer">
        <div>
          ...
          <div class="text-2xl md:text-5xl mt-4 md:mt-10">ភិន </div>
          <div class="text-2xl md:text-5xl mt-2 md:mt-10">ចន្ធី</div>
        </div>
        ...
        <div>
          ...
          <div class="text-2xl md:text-5xl mt-4 md:mt-10">មាត</div>
          <div class="text-2xl md:text-5xl mt-2 md:mt-10">សូយនាង</div>
        </div>
      </div>
      ...
      <div class="text-3xl md:text-5xl mt-4 md:mt-10 font-khmer">
          ថ្ងៃ ចន្ទ ទី ០៥ ខែ ឧសភា ឆ្នាំ២០២៥
      </div>
      <div class="text-yellow-500 text-xl md:text-3xl font-khmer-kh mt-10">
        ចុះពីផ្លូវធំចម្ងាយប្រមាណជាង​ ១០០0 ម៉ែត្រ
      </div>
      <button
      ...
      <section class="mt-40">
        ...
        >
          <div>
            <div>លោក ម៉ាង ភេត</div>
            <div>លោកស្រី យ៉ាន់ សាម៉េន</div>
          </div>
          <div>
            <div>លោក ពៅ មាត</div>
            <div>លោកស្រី​ ហ៊ាង ឈាង</div>
          </div>
        </div>
        <div  
        ...
        <div class="text-3xl md:text-5xl mt-4 md:mt-10 font-khmer">
          ថ្ងៃចន្ទ ទី០៥ ខែមីនា ឆ្នាំ២០២៥
        </div>
        <button
          ...
          onclick="window.open('https://maps.windows.com/?form=WNAMSH&collection=point.11.630174_105.234795_Point"
        >
      ...
      <section class="mt-40">
        ...
        <div class="flex justify-center gap-2 md:gap-5">
          <div>
            <img
              class="md:w-96 w-60"
              src="../PHOTO/photo_2025-04-12_10-51-34 (2).jpg"
              alt=""
            />
          </div>
          <div>
            <img
              class="md:w-96 w-60"
              src="../PHOTO/photo_2025-04-12_10-51-48.jpg"
              alt=""
            />
          </div>
        </div>
        <div class="flex justify-center gap-2 md:gap-5 mt-2">
          <div>
            <img
              class="md:w-96 w-60"
              src="../PHOTO/photo_2025-04-12_10-52-32.jpg"
              alt=""
            />
          </div>
          <div>
            <img
              class="md:w-96 w-60"
              src="../PHOTO/photo_2025-04-12_10-56-13.jpg"
              alt=""
            />
          </div>
        </div>
        ...
        <div class="p-1">
          ...
          <div class="mt-5">
            <p v-if="selectedDay === 'day22'">
              ...
              <h2 class="text-2xl md:text-4xl font-khmer-kh text-yellow-200">
               អញ្ជើញភ្ញៀវកិត្តិយសពិសាភោជនាអាហារ
              </h2>
            </p>
